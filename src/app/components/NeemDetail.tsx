...
import ProductImage1 from "../images/NeemImage.webp";
import ProductImage2 from "../images/NeemImage1.webp";
    ...
    <div className="min-h-screen bg-yellow-400 p-8">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            {images.map((img, idx) => (
              <button
                ...
                className={`w-24 h-24 rounded-lg overflow-hidden relative ${
                  mainImage === idx ? "ring-2 ring-teal-600" : ""
                }`}
              >
                <Image
                  src={img}
        ...
        <div className="space-y-6">
          <h1 className="text-3xl font-bold text-gray-900">Neem Agarbatti</h1>
